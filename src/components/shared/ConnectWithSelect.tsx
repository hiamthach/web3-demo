...
import { CHAINS, getAddChainParameters } from '@/config/constants/chains.const';
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      {!(connector instanceof GnosisSafe) && (
        <ChainSelect
          activeChainId={desiredChainId as number}
      ...
      {isActive ? (
        error ? (
          <button onClick={() => switchChain(desiredChainId as number)}>
            Try again?
          </button>
        ) : (
          <button
          ...
          onClick={() =>
            connector instanceof GnosisSafe
              ? void connector
                  ...
                  .catch(setError)
              : switchChain(desiredChainId as number)
          }
